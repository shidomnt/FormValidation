function Validator(formSelector) {
    ...
    if (formElement) {
        ...
        function handleValidate(inputElement) {
            ...
            switch (inputElement.type) {
                ...
                case 'radio':
                    ...
                    break
                default:
                    errorMessage = rules.find(rule => rule(inputElement.value) !== undefined)?.(
                        inputElement.value
                    )
            }
            ...
            if (errorMessage) {
                ...
                inputElement.closest('.form-group').querySelector('.form-message').innerHTML =
                    errorMessage
            } else {
        ...
        formElement.onsubmit = event => {
            ...
            const inputElements = Array.from(formElement.querySelectorAll('[rules][name]'))
                ...
                let result = inputElements.reduce((result, inputElement) => {
                    switch (inputElement.type) {
                        case 'checkbox':
                            ...
                            break
                        case 'radio':
                            if (inputElement.checked) result[inputElement.name] = inputElement.value
                            break
                        default:
